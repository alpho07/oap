        ...
        <div class="col-lg-12 col-md-12 col-sm-12 ">
            <div class="grid-view product card">
                <div class="product-image col-lg-4 col-md-4 col-sm-4">
                    ...
                    <a href="<?php echo base_url() . 'home/loadsingle/' . $ad->id.'/'.str_replace(" ", "-", $ad->title); ?>"><img src="<?php echo base_url() . $ad->image_path; ?>" alt="<?php $ad->title; ?>" width="150px" height="180px">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="product-info">
                        ...
                        <span class="price"><a href="<?php echo base_url() . 'home/loadsingle/' . $ad->id.'/'.str_replace(" ", "-", $ad->title); ?>"><?php echo $ad->title; ?></a></span>
